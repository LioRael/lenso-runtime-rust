...
export default {
  async fetch(request, env) {
    ...
    if (input.length > 1024 || !['normal', 'missing-factory', 'startup-failure', 'trap', 'driver', 'async-trap', 'task-trap', 'async-panic', 'async-pending', 'recovery', 'conformance', 'io-exchange', 'io-delayed', 'io-slow', 'io-cancel', 'io-recovery'].includes(mode)) return new Response('Invalid probe', { status: 400 });
